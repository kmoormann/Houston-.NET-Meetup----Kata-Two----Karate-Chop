...
namespace BinaryChop.Test
{
    ...
    public class BinaryChopTest
    {
        ...
        public void HandlesEmptyArrayTest()
        {
            ...
            actual = BinaryChopper.Chop(0,searchArray);
        ...
        public void SingleElementArrayFoundTest()
        {
            ...
            actual = BinaryChopper.Chop(1, searchArray);
        ...
        public void FindsLeftMostElementTest()
        {
            ...
            int actual = BinaryChopper.Chop(1, searchArray);
        ...
        public void FindsRightMostElementTest()
        {
            ...
            //Act
            int actual = BinaryChopper.Chop(5, searchArray);
        ...
        public void FindsAnyElementPosition()
        {
            ...
            {
                expected = i;
                actual = BinaryChopper.Chop(i, searchArray);
                Assert.AreEqual(expected, actual);
            }
        }
    }
